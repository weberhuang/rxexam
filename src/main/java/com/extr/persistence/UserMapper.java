...
public interface UserMapper {
	 ...
	 *            role_id
	 */
	public void grantUserRole(@Param("u_id") String user_id, @Param("r_id") String role_id);
	 ...
	 * @return
	 */
	public List<User> getUserListByRoleId(@Param("r_id") int role_id, @Param("page") Page<User> page);
	 ...
	 * @return
	 */
	public List<Role> getRoleListByUserId(@Param("u_id") String user_id, @Param("page") Page<Role> page);
	 ...
	 * @param user_id
	 */
	public void deleteUserRoleByUserId(@Param("u_id") String user_id);
